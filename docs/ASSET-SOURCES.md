...
All final photo assets were downloaded locally through the Unsplash API, with download endpoints triggered and recorded in `public/images/mobile-lift/manifest.json`.
